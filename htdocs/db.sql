...
--
-- Name: alert_queue; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
--
-- Name: alert_queue_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE alert_queue_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
ALTER TABLE public.alert_queue_id_seq OWNER TO postgres;

--
-- Name: alert_queue_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE alert_queue_id_seq OWNED BY alert_queue.id;
...
ALTER SEQUENCE counties_gid_seq OWNED BY counties.gid;
...
CREATE SEQUENCE tornado_warnings_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
ALTER TABLE public.tornado_warnings_id_seq OWNER TO postgres;

--
-- Name: tornado_warnings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE tornado_warnings_id_seq OWNED BY tornado_warnings.id;
...
CREATE SEQUENCE user_submits_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MAXVALUE
    NO MINVALUE
...
ALTER TABLE public.user_submits_id_seq OWNER TO postgres;

--
-- Name: user_submits_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE user_submits_id_seq OWNED BY user_submits.id;
...
ALTER TABLE alert_queue ALTER COLUMN id SET DEFAULT nextval('alert_queue_id_seq'::regclass);
...
ALTER TABLE counties ALTER COLUMN gid SET DEFAULT nextval('counties_gid_seq'::regclass);
...
ALTER TABLE user_submits ALTER COLUMN id SET DEFAULT nextval('user_submits_id_seq'::regclass);
...
CREATE INDEX counties_the_geom_gist ON counties USING gist (the_geom);


--
-- Name: endtime_count_state_idx; Type: INDEX; Schema: public; Owner: postgres; Tablespace: 
--
