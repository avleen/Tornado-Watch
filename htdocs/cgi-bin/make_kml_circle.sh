...
echo "INSERT INTO tmploc SELECT location FROM user_registration order by create_date desc limit 100" | psql -qtU postgres -d tornadowatch >> ${kmlfile}
...
echo 'Location: http://maps.google.com/maps?q=http:%2F%2Ftw.silverwraith.com%2Fhtml%2Fauto_rep_circle.kmz'
echo
echo
