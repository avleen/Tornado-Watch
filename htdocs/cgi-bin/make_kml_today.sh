...
mydir=$( dirname $0 )
kmlfile=${mydir}/../htdocs/auto_rep_today.kml
kmlfilez=${mydir}/../htdocs/auto_rep_today.kmz
...
echo 'Location: http://maps.google.com/maps?q=http:%2F%2Ftw.silverwraith.com%2Fhtml%2Fauto_rep_today.kmz'
echo
echo
